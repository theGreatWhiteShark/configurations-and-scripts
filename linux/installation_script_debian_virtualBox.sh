...
function general_install() {
	...
	sudo apt -y install apt-file at imagemagick pandoc scrot meld thunderbird clementine terminator pasystray pavucontrol ispell ingerman wngerman aspell-de htop i3-wm i3blocks i3lock i3status borgbackup qasmixer qasconfig r-base pmount xcompmgr ack vlc global info liblo-tools autoconf make gcc g++ pkg-config synapse caja pass
